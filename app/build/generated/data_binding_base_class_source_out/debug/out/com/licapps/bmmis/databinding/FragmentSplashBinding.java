...
public final class FragmentSplashBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView licLogoIV;

  private FragmentSplashBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView licLogoIV) {
    this.rootView = rootView;
    this.licLogoIV = licLogoIV;
  }
  ...
  public static FragmentSplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.licLogoIV;
      ImageView licLogoIV = ViewBindings.findChildViewById(rootView, id);
      if (licLogoIV == null) {
        break missingId;
      }

      return new FragmentSplashBinding((ConstraintLayout) rootView, licLogoIV);
    }
