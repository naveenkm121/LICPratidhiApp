...
public final class FragmentResourceBinding implements ViewBinding {
  ...
  private FragmentResourceBinding(@NonNull RelativeLayout rootView, @NonNull RecyclerView casesRV,
  ...
  public static FragmentResourceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentResourceBinding((RelativeLayout) rootView, casesRV, channelsMTV,
          depositsMTV, headerCV, noResultIV, binding_progressBar, binding_progressBarShim);
    }
