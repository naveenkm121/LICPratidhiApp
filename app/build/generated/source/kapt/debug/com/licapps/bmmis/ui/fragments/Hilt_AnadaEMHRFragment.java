 ...
 */
public abstract class Hilt_AnadaEMHRFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AnadaEMHRFragment() {
    super();
  }

  Hilt_AnadaEMHRFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AnadaEMHRFragment_GeneratedInjector) this.generatedComponent()).injectAnadaEMHRFragment(UnsafeCasts.<AnadaEMHRFragment>unsafeCast(this));
    }
  }
