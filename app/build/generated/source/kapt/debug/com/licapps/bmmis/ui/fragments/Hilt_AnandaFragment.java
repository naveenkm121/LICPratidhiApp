 ...
 */
public abstract class Hilt_AnandaFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AnandaFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AnandaFragment_GeneratedInjector) this.generatedComponent()).injectAnandaFragment(UnsafeCasts.<AnandaFragment>unsafeCast(this));
    }
  }
