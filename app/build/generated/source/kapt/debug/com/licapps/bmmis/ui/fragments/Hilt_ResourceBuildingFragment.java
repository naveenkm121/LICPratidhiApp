 ...
 */
public abstract class Hilt_ResourceBuildingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ResourceBuildingFragment() {
    super();
  }

  Hilt_ResourceBuildingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ResourceBuildingFragment_GeneratedInjector) this.generatedComponent()).injectResourceBuildingFragment(UnsafeCasts.<ResourceBuildingFragment>unsafeCast(this));
    }
  }
