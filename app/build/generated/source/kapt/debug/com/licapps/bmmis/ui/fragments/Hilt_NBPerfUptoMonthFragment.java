 ...
 */
public abstract class Hilt_NBPerfUptoMonthFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NBPerfUptoMonthFragment() {
    super();
  }

  Hilt_NBPerfUptoMonthFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NBPerfUptoMonthFragment_GeneratedInjector) this.generatedComponent()).injectNBPerfUptoMonthFragment(UnsafeCasts.<NBPerfUptoMonthFragment>unsafeCast(this));
    }
  }
