 ...
 */
public abstract class Hilt_WebViewFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WebViewFragment() {
    super();
  }

  Hilt_WebViewFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WebViewFragment_GeneratedInjector) this.generatedComponent()).injectWebViewFragment(UnsafeCasts.<WebViewFragment>unsafeCast(this));
    }
  }
