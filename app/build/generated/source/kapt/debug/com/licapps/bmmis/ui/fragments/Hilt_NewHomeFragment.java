 ...
 */
public abstract class Hilt_NewHomeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NewHomeFragment() {
    super();
  }

  Hilt_NewHomeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewHomeFragment_GeneratedInjector) this.generatedComponent()).injectNewHomeFragment(UnsafeCasts.<NewHomeFragment>unsafeCast(this));
    }
  }
