 ...
 */
public abstract class Hilt_NBForDayFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NBForDayFragment() {
    super();
  }

  Hilt_NBForDayFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NBForDayFragment_GeneratedInjector) this.generatedComponent()).injectNBForDayFragment(UnsafeCasts.<NBForDayFragment>unsafeCast(this));
    }
  }
