 ...
 */
public abstract class Hilt_ProspectiveNewFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProspectiveNewFragment() {
    super();
  }

  Hilt_ProspectiveNewFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProspectiveNewFragment_GeneratedInjector) this.generatedComponent()).injectProspectiveNewFragment(UnsafeCasts.<ProspectiveNewFragment>unsafeCast(this));
    }
  }
