 ...
 */
public abstract class Hilt_MABFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MABFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MABFragment_GeneratedInjector) this.generatedComponent()).injectMABFragment(UnsafeCasts.<MABFragment>unsafeCast(this));
    }
  }
