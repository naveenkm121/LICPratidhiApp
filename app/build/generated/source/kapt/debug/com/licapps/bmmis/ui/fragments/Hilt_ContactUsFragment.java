 ...
 */
public abstract class Hilt_ContactUsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ContactUsFragment() {
    super();
  }

  Hilt_ContactUsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ContactUsFragment_GeneratedInjector) this.generatedComponent()).injectContactUsFragment(UnsafeCasts.<ContactUsFragment>unsafeCast(this));
    }
  }
