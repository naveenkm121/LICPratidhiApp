 ...
 */
public abstract class Hilt_PeristenceFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PeristenceFragment() {
    super();
  }

  Hilt_PeristenceFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PeristenceFragment_GeneratedInjector) this.generatedComponent()).injectPeristenceFragment(UnsafeCasts.<PeristenceFragment>unsafeCast(this));
    }
  }
