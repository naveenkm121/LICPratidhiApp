 ...
 */
public abstract class Hilt_NBChannelWiseFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NBChannelWiseFragment() {
    super();
  }

  Hilt_NBChannelWiseFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NBChannelWiseFragment_GeneratedInjector) this.generatedComponent()).injectNBChannelWiseFragment(UnsafeCasts.<NBChannelWiseFragment>unsafeCast(this));
    }
  }
