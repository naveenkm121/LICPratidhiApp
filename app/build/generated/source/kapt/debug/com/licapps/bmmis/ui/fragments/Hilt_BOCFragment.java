 ...
 */
public abstract class Hilt_BOCFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BOCFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BOCFragment_GeneratedInjector) this.generatedComponent()).injectBOCFragment(UnsafeCasts.<BOCFragment>unsafeCast(this));
    }
  }
