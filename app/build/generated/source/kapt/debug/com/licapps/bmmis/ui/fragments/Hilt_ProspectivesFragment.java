 ...
 */
public abstract class Hilt_ProspectivesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProspectivesFragment() {
    super();
  }

  Hilt_ProspectivesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProspectivesFragment_GeneratedInjector) this.generatedComponent()).injectProspectivesFragment(UnsafeCasts.<ProspectivesFragment>unsafeCast(this));
    }
  }
