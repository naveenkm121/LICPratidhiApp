 ...
 */
public abstract class Hilt_NBPerformanceFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NBPerformanceFragment() {
    super();
  }

  Hilt_NBPerformanceFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NBPerformanceFragment_GeneratedInjector) this.generatedComponent()).injectNBPerformanceFragment(UnsafeCasts.<NBPerformanceFragment>unsafeCast(this));
    }
  }
