 ...
 */
public abstract class Hilt_ActivisationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ActivisationFragment() {
    super();
  }

  Hilt_ActivisationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ActivisationFragment_GeneratedInjector) this.generatedComponent()).injectActivisationFragment(UnsafeCasts.<ActivisationFragment>unsafeCast(this));
    }
  }
