 ...
 */
public abstract class Hilt_ResourceFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ResourceFragment() {
    super();
  }

  Hilt_ResourceFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ResourceFragment_GeneratedInjector) this.generatedComponent()).injectResourceFragment(UnsafeCasts.<ResourceFragment>unsafeCast(this));
    }
  }
