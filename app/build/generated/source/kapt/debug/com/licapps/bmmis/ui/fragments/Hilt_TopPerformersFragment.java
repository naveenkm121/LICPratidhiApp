 ...
 */
public abstract class Hilt_TopPerformersFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TopPerformersFragment() {
    super();
  }

  Hilt_TopPerformersFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TopPerformersFragment_GeneratedInjector) this.generatedComponent()).injectTopPerformersFragment(UnsafeCasts.<TopPerformersFragment>unsafeCast(this));
    }
  }
