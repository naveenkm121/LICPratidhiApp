 ...
 */
public abstract class Hilt_InactiveResourcesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InactiveResourcesFragment() {
    super();
  }

  Hilt_InactiveResourcesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InactiveResourcesFragment_GeneratedInjector) this.generatedComponent()).injectInactiveResourcesFragment(UnsafeCasts.<InactiveResourcesFragment>unsafeCast(this));
    }
  }
