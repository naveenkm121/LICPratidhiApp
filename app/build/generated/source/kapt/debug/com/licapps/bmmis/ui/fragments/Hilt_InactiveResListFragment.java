 ...
 */
public abstract class Hilt_InactiveResListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InactiveResListFragment() {
    super();
  }

  Hilt_InactiveResListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InactiveResListFragment_GeneratedInjector) this.generatedComponent()).injectInactiveResListFragment(UnsafeCasts.<InactiveResListFragment>unsafeCast(this));
    }
  }
