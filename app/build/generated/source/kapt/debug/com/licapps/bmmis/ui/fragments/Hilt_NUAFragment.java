 ...
 */
public abstract class Hilt_NUAFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NUAFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NUAFragment_GeneratedInjector) this.generatedComponent()).injectNUAFragment(UnsafeCasts.<NUAFragment>unsafeCast(this));
    }
  }
