 ...
 */
public abstract class Hilt_PlanPerfFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PlanPerfFragment() {
    super();
  }

  Hilt_PlanPerfFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlanPerfFragment_GeneratedInjector) this.generatedComponent()).injectPlanPerfFragment(UnsafeCasts.<PlanPerfFragment>unsafeCast(this));
    }
  }
