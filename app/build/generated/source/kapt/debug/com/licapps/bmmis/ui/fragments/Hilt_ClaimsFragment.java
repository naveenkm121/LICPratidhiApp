 ...
 */
public abstract class Hilt_ClaimsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ClaimsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClaimsFragment_GeneratedInjector) this.generatedComponent()).injectClaimsFragment(UnsafeCasts.<ClaimsFragment>unsafeCast(this));
    }
  }
