 ...
 */
public abstract class Hilt_WishesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WishesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WishesFragment_GeneratedInjector) this.generatedComponent()).injectWishesFragment(UnsafeCasts.<WishesFragment>unsafeCast(this));
    }
  }
