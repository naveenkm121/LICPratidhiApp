 ...
 */
public abstract class Hilt_EMHRFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EMHRFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EMHRFragment_GeneratedInjector) this.generatedComponent()).injectEMHRFragment(UnsafeCasts.<EMHRFragment>unsafeCast(this));
    }
  }
