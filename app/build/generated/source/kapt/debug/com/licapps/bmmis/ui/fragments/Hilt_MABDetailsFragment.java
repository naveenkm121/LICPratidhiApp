 ...
 */
public abstract class Hilt_MABDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MABDetailsFragment() {
    super();
  }

  Hilt_MABDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MABDetailsFragment_GeneratedInjector) this.generatedComponent()).injectMABDetailsFragment(UnsafeCasts.<MABDetailsFragment>unsafeCast(this));
    }
  }
