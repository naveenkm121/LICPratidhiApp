...
class HomeAdapter() : RecyclerView.Adapter<CommonHomeViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CommonHomeViewHolder {
        return when (viewType) {
            HomeViewType.SMALL_ICON_VIEW_TYPE -> {
                ...
                CommonHomeViewHolder(parent.context, binding, viewType)
            }
            HomeViewType.SMALL_BANNER_VIEW_TYPE -> {
                val binding: ItemCategoryHorizontalBinding = ItemCategoryHorizontalBinding.inflate(LayoutInflater.from(parent.context), parent, false)
                CommonHomeViewHolder(parent.context, binding, viewType)
            }
            HomeViewType.BIG_BANNER_VIEW_TYPE -> {
                val binding: ItemCategoryHorizontalBinding = ItemCategoryHorizontalBinding.inflate(LayoutInflater.from(parent.context), parent, false)
                CommonHomeViewHolder(parent.context, binding, viewType)
            }
            HomeViewType.PRODUCT_CARD_VIEW_TYPE -> {
                val binding: ItemCategoryHorizontalBinding = ItemCategoryHorizontalBinding.inflate(LayoutInflater.from(parent.context), parent, false)
                CommonHomeViewHolder(parent.context, binding, viewType)
            }
    ...
    fun bind(item: Any) {
        ...
        when (viewType) {
            ...
            SMALL_ICON_VIEW_TYPE -> {
                ...
                itemBinding.nameTV.text = item.type
