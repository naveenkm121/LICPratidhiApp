...
import com.licapps.bmmis.databinding.FragmentNbPerfUptoMonthBinding
...
@AndroidEntryPoint
class NBPerfUptoMonthFragment :Fragment() {

    private var binding:FragmentNbPerfUptoMonthBinding by autoCleared()
    private val viewModel: NBUptoMonthhViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        binding = FragmentNbPerfUptoMonthBinding.inflate(inflater, container, false)
        return binding.root
    }
